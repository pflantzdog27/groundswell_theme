                ...
                <footer class="blog-meta-info">
                    ...
                    if($categories){
                        foreach($categories as $category) {
                            $output .= '<a href="'.get_category_link( $category->term_id ).'" title="' . esc_attr( sprintf( __( "View all posts in %s" ),
...
<section id="blog" class="content-section">
    <div class="container">
        <div class="row" style="margin-bottom: 25px;">
            <div class="col-sm-6">
                If you like this post <a style="text-decoration: underline;" href="#">Subscribe</a>, <a style="text-decoration: underline;" href="#">Donate</a> or read another below:
            </div>
