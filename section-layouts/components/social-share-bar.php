<div class="social-link-bar">
    <ul class="list-unstyled col-sm-8 col-sm-offset-2">
        <li class="facebook col-xs-4"><a class="facebook-share" href="" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent(location.href),'facebook-share-dialog','width=626,
            height=436'); //_gaq.push(['_trackEvent', 'Facebook',
        // 'Facebook-Top Single Post Page', '<?php //the_title();?>']);return false;">
