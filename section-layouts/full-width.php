<div class="section-template parallax single-column-section row">
    ...
    <?php if($fullBlock == 'Curated Carousel') : ?>
        <?php if( $fullBlockCarouselItems ): /* If items exist in partners custom post type */ ?>
            <div id="<?php echo $fullBlockCarouselID; ?>" class="carousel slide">
                ...
                <ol class="carousel-indicators">
                    <li class="active" data-target="#<?php echo $fullBlockCarouselID; ?>" data-slide-to="0"></li>
                    <li data-target="#<?php echo $fullBlockCarouselID; ?>" data-slide-to="1"></li>
                </ol>
