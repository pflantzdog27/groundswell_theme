<?php if ( is_active_sidebar( 'sidebar_blog_single' ) ) : ?>
    <aside class="col-sm-3 col-xs-12" id="right-sidebar">
        ...
        for($i = 0; $i < sizeof($all_cats_of_post); $i++) { ?>
            ...
            if($cat_posts && $all_cats_of_post[0]->cat_ID != 27 && $all_cats_of_post[0]->cat_ID != 26 && $all_cats_of_post[0]->cat_ID != 28 && $all_cats_of_post[0]->cat_ID != 29 && $all_cats_of_post[0]->cat_ID != 1) { ?>
